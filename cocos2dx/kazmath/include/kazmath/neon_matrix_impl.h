...
#ifdef __arm__
#if defined(__QNX__) || defined(ANDROID) || defined(I3D_ARCH_ARM) || defined(__native_client__) || defined(TIZEN) || defined(SYSTEM_QT)// MARMALADE CHANGE: Added for Marmalade support
